...
class NM_Cropper_wooproduct extends PPOM_Inputs{
	...
	private function get_settings(){
		...
		return array (
				...
				'viewport' => array (
						'type' => 'text',
						'title' => __ ( 'Viewport height,width', 'ppom' ),
						'desc' => __ ( 'Separated by command h,w e.g: 200,200 <a target="_blank" href="'.esc_url($croppie_options_link).'">Options Help</a>', 'ppom' ) 
				),
				'viewport_type' => array (
						'type' => 'select',
						'title' => __ ( 'Viewport type', 'ppom' ),
						'desc' => __ ( 'Squar or circle <a target="_blank" href="'.esc_url($croppie_options_link).'">Options Help</a>', 'ppom' ),
						'options'	=> array('square' => 'Squar',
										'circle'	=> 'Circle')
				),
				'boundary' => array (
						'type' => 'text',
						'title' => __ ( 'Boundar height,width', 'ppom' ),
						'desc' => __ ( 'Separated by command h,w e.g: 200,200 <a target="_blank" href="'.esc_url($croppie_options_link).'">Options Help</a>', 'ppom' ) 
				),
				...
				'enforce_boundary' => array (
						...
						'desc' => __ ( 'Restricts zoom so image cannot be smaller than viewport. <a target="_blank" href="'.esc_url($croppie_options_link).'">Options Help</a>', 'ppom' ),
						'default' => 'on',
				),
				'resize' => array (
						'type' => 'checkbox',
						'title' => __ ( 'Allow Resize', 'ppom' ),
						'desc' => __ ( 'Show cropping handler resize. <a target="_blank" href="'.esc_url($croppie_options_link).'">Options Help</a>', 'ppom' )
				),
				'enable_zoom' => array (
						'type' => 'checkbox',
						'title' => __ ( 'Enable Zoom', 'ppom' ),
						'desc' => __ ( 'Enable zooming functionality. If set to false - scrolling and pinching would not zoom. <a target="_blank" href="'.esc_url($croppie_options_link).'">Options Help</a>', 'ppom' ),
						'default' => 'on',
				),
				'show_zoomer' => array (
						'type' => 'checkbox',
						'title' => __ ( 'Show Zoomer', 'ppom' ),
						'desc' => __ ( 'Hide or Show the zoom slider. <a target="_blank" href="'.esc_url($croppie_options_link).'">Options Help</a>', 'ppom' ),
						'default' => 'on',
				),
				'enable_exif' => array (
						'type' => 'checkbox',
